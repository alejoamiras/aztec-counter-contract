...
export class CounterContract extends ContractBase {
  ...
  public static get storage(): ContractStorageLayout<'owner' | 'counters' | 'total_counter'> {
      return {
        owner: {
      slot: new Fr(1n),
    },
...
total_counter: {
      ...
      } as ContractStorageLayout<'owner' | 'counters' | 'total_counter'>;
    }
  ...
  public declare methods: {
    ...
    /** get_total_counter() */
    get_total_counter: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
